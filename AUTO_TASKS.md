...
| ID | 任务 | 文件 | 状态 |
|----|------|------|------|
| T1 | 加固内容过滤器 - 增强 Prompt Injection 防护 | `app/services/content_filter.py` | [ ] Pending |
| T2 | 加固设备限制 - 修复潜在并发竞态条件 | `app/middleware/auth.py` | [ ] Pending |
| T3 | 加固默认配置 - 确保生产环境不使用弱密钥 | `app/config.py` | [ ] Pending |
