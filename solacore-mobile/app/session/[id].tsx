...
import type { CrisisResponse, Message, SolveStep, StreamDoneEvent } from '../../types/solve';
...
const CrisisAlert: React.FC<{
  ...
  <View style={styles.crisisOverlay}>
    <View style={styles.crisisCard}>
      ...
      <Text style={styles.crisisMessage}>{crisis.message ?? t('solve.crisisMessage')}</Text>
