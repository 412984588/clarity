...
| R03 | **Google Play Console 未开通** | Medium | High | 注册 Google Play Developer ($25 一次性) | Product | OPEN |
| R04 | **Stripe Live Mode 未激活** | High | Medium | 完成 Stripe 身份验证，激活 Live Mode | Finance | OPEN |
| R05 | **RevenueCat 生产配置缺失** | High | Medium | 配置生产环境 App，关联 App Store / Play Store | Product | OPEN |
