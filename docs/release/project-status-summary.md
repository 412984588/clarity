...
| **Beta launch message** | See `docs/release/beta-launch-message.md` - Ready-to-send invite messages | High |
| **Beta release notes (2025-12-24)** | See `docs/release/beta-release-notes-2025-12-24.md` - Current version Release Notes | High |
...
| **Beta feedback summary template** | See `docs/release/beta-feedback-summary-template.md` - 反馈汇总（每周） | High |
| **Beta retrospective template** | See `docs/release/beta-retrospective-template.md` - 复盘（Beta 结束时） | High |
| **Beta issue intake guide** | See `docs/release/beta-issue-intake.md` - Issue 接收指南（报告渠道/严重性/SLA） | High |
| **Remaining work report** | See `docs/release/remaining-work.md` | High |
| **Release docs hub** | See `docs/release/index.md` | High |
| **Release docs inventory** | See `docs/release/release-docs-inventory.md` - 59 份文档清单与分类 | High |
